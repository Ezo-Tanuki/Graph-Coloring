...
public class NodePanel extends JPanel {
    ...
    private LinkedList<NodePanel> connectedNodes;

    public NodePanel() {
        this(new Point(0, 0));
    }

    public NodePanel(Point pt) {
        this(pt, 40, null);
    }

    public NodePanel(Point pt, int radius, String identifier) {
        if (identifier == null) {
    ...
    public LinkedList<NodePanel> getConnectedNodes() {
        return connectedNodes;
    }

    public void setConnectedNodes(LinkedList<NodePanel> connectedNodes) {
        this.connectedNodes = connectedNodes;
    }

    public void addConnection(NodePanel n) {
        this.connectedNodes.add(n);
    }

    public void removeConnection(NodePanel n) {
